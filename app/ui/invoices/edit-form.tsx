...
export default function EditInvoiceForm({
  ...
  return (
    ...
    // Instead, pass id to the Server Action using JS bind. This will ensure that any values passed to the Server Action are encoded.
    ...
    <form action={dispatch}>
      ...
      >
        ...
        {/* Invoice Amount */}
        <div className="mb-4" aria-describedby="invoice-error">
